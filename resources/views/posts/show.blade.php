    ...
    <section class="px-6 py-8">
        ...
        @else
            <p class="font-semibold">
                <a href="/register" class="font-semibold hover:underline text-blue-500">Register</a> or <a href="/login" class="font-semibold hover:underline text-blue-500">Log in</a> to leave a comment.
            @endauth
